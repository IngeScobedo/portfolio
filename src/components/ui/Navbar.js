    ...
    <nav className="px-2 sm:px-4 py-2.5 flex justify-center items-center z-90">
      <div className="container flex flex-wrap justify-between items-center mx-auto w-5/6 bg-white p-3 rounded-xl">
        ...
        <div className="flex md:order-2">
          <button
            type="button"
            className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2"
          >
           <a href="https://github.com/IngeScobedo" target="_blank" className="flex" rel="noreferrer">
           <svg
          ...
          >
            <a href={pdf} download="CurriculumAlanEscobedo.pdf">
              Descargar CV
            </a>
          </button>
          <button
        ...
        <div
          className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1 z-90"
          id="mobile-menu-4"
        >
